...
public class GameBoard {
	...
	/**
	 * gets the surrounding blocks, the neighbourhood
	 * @param loc center location of the neighbourhood
	 * @param distance 1 or 2 depending on if its the closest neighbours or the 5x5 grid
	 * @return list of surrounding locations, with the center in loc
	 */
	public List<Location> getNeighbourhood(Location loc, int distance){
		return grid.getNeighbourhood(loc, distance);
	}
